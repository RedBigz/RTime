...
SettingSetTime::SettingSetTime(Pinetime::Controllers::DateTime& dateTimeController,
  ...
  lv_obj_set_style_local_text_font(staticLabel, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &ibm_plex_mono_42);
  ...
  lv_obj_set_style_local_text_font(lblampm, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &ibm_plex_mono_bold_20);
