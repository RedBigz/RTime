...
Dice::Dice(Controllers::MotionController& motionController,
  ...
  lv_obj_t* nCounterLabel = MakeLabel(&ibm_plex_mono_bold_20,
                                      LV_COLOR_WHITE,
  ...
  lv_obj_t* dCounterLabel = MakeLabel(&ibm_plex_mono_bold_20,
                                      LV_COLOR_WHITE,
                                      LV_LABEL_LONG_EXPAND,
                                      0,
                                      LV_LABEL_ALIGN_CENTER,
  ...
  resultTotalLabel = MakeLabel(&ibm_plex_mono_42,
                               ...
                               11,
                               38);
  resultIndividualLabel = MakeLabel(&ibm_plex_mono_bold_20,
                                    resultColors[currentColorIndex],
                                    LV_LABEL_LONG_BREAK,
                                    90,
                                    LV_LABEL_ALIGN_CENTER,
  ...
  btnRollLabel = MakeLabel(&ibm_plex_mono_bold_20,
                           LV_COLOR_WHITE,
                           LV_LABEL_LONG_EXPAND,
                           0,
                           LV_LABEL_ALIGN_CENTER,
